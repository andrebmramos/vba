...
'   Source: https://www.youtube.com/watch?v=RsyqqzholVk&ab_channel=DineshKumarTakyar
'   Usage: = Translate(Range("A2"), "en", "es")
'   WIP: Create optional source language input. Default to auto detect language
